...
public class Course extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1978080415763476706L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Course\",\"namespace\":\"schemas\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"name\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"description\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public Course(java.lang.Long id, java.lang.String name, java.lang.String description) {
    this.id = id;
    this.name = name;
   ...
   */
  public static schemas.Course.Builder newBuilder() {
    return new schemas.Course.Builder();
  }
   ...
   * @return A new Course RecordBuilder
   */
  public static schemas.Course.Builder newBuilder(schemas.Course.Builder other) {
    if (other == null) {
      return new schemas.Course.Builder();
    } else {
      return new schemas.Course.Builder(other);
    }
  }
   ...
   * @return A new Course RecordBuilder
   */
  public static schemas.Course.Builder newBuilder(schemas.Course other) {
    if (other == null) {
      return new schemas.Course.Builder();
    } else {
      return new schemas.Course.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Course>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(schemas.Course.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(schemas.Course other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public schemas.Course.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public schemas.Course.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public schemas.Course.Builder setName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public schemas.Course.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public schemas.Course.Builder setDescription(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public schemas.Course.Builder clearDescription() {
      description = null;
